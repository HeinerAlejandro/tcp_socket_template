...
@inject
def get_products(
    socket_client: sockets.SocketClientAbstract = Provide[
        CoreContainer.socket_instance
    ],
    ...
    socket_client.send(
        {"http_verb": "GET", "path": {}, "query_params": ""}, url_type="PRODUCTS"
    )
...
def get_product(
    ...
    socket_client.send(
        {"http_verb": "GET", "path": json.dumps({"code": code}), "query_params": ""},
        url_type="PRODUCT",
    )
